        ...
        makeResult(
          {
            ...
            workflow: [
              ...
              "Local execution is the default. Remote executors are optional and must be explicitly configured/selected. JK does not silently pull, reset, rebase, or force-update another machine's checkout; keep one durable source of truth for shared projects and synchronize Git explicitly.",
